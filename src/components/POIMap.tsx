...
const VILLA_X = 234;  // L'Arbois (43.3093°N, 6.6432°E)
const VILLA_Y = 127;
const FERRY_X = 220;  // Port de Saint-Tropez (43.2722°N, 6.6378°E)
const FERRY_Y = 260;
    ...
    <div className="poi-map relative w-full">
      <svg viewBox="0 0 400 500" className="w-full h-auto block" role="img" aria-label="Carte interactive des adresses autour de L’Arbois">
        ...
        <path
          ...
          d={`M${VILLA_X},${VILLA_Y + 8} Q245,195 ${FERRY_X},${FERRY_Y}`}
          stroke="#b8935a"
          strokeOpacity="0.5"
          strokeWidth="0.9"
          fill="none"
          strokeDasharray="3 6"
        />
        <text x="252" y="200" fill="#c9a97a" fontSize="7" letterSpacing="4" fontFamily="Satoshi, sans-serif" opacity="0.6">15′ · BATEAU</text>
