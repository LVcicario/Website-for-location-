...
const en: ChapterCopy = {
  ...
  art_of_living: {
    ...
    pois: [
      ...
      { name: "Nartelle beach", kind: "Fine sand · 1 km of shoreline", distance: "5–10 min by car", access: "Reachable by car only. 3 km east via Avenue Romée de Villeneuve (D559) — 5 min in low season, up to 10 min in high season. Beach parking.", activities: "Fine sand, calm water (ideal for children), beach clubs (Mahi Plage, La Gaillarde, Havana), paddle, loungers, lunch on the sand.", transport: "car", mapX: 291, mapY: 84 },
      { name: "Le Prao", kind: "Restaurant & private beach · La Nartelle", distance: "5–10 min by car", access: "Reachable by car only. 39 Avenue du Général Touzet du Vigier, on Nartelle beach. Valet parking in summer.", activities: "One of the oldest private beaches on the Riviera. Mediterranean restaurant, lounge bar, loungers facing the sea.", transport: "car", mapX: 302, mapY: 109 },
      { name: "Sénéquier", kind: "Iconic harbour café · Saint-Tropez", distance: "15 min by boat", access: "Bateaux Verts shuttles from Jetée Olivier Bausset (5 min walk from L’Arbois). 1 to 4 rotations per hour, 7 days a week, ten months a year.", activities: "Institution since 1887. Vivid red terrace on the harbour, early breakfast, sunset apéritif, the finest yacht-watching seat.", transport: "boat", mapX: 224, mapY: 260 },
      { name: "Place des Lices", kind: "Pétanque, plane trees, Provençal market", distance: "15 min boat + 5 min walk", access: "Off the boat at the harbour, 300 m up Rue Gambetta. Market Tuesday & Saturday morning (8am-1pm).", activities: "Pétanque under centennial plane trees, growers’ market, shaded terraces, Le Café (historic brasserie), designer shops.", transport: "boat", mapX: 229, mapY: 268 },
      { name: "La Vague d’Or · Cheval Blanc", kind: "Gastronomic · 3 Michelin stars", distance: "15 min boat + 7 min walk", access: "Bateaux Verts to the harbour, then walk along the Bouillabaisse beach. Cheval Blanc Saint-Tropez hotel.", activities: "Mediterranean cuisine by chef Arnaud Donckele. Panoramic sea view, gardens, exceptional service. Booking far in advance.", transport: "boat", mapX: 187, mapY: 281 },
      { name: "La Voile · La Réserve Ramatuelle", kind: "Gastronomic · 2 Michelin stars", distance: "30 min by car", access: "Via Chemin des Tournels through Ramatuelle. La Réserve Ramatuelle hotel, on the heights.", activities: "Mediterranean cuisine by chef Eric Canino, around garden herbs and small-boat fish. Sweeping view over Pampelonne bay.", transport: "car", mapX: 195, mapY: 461 },
      { name: "Pampelonne beach", kind: "Club 55, Loulou, Verde Beach, La Réserve", distance: "30 min by car", access: "Route des plages via Ramatuelle. Valet parking at every club. Private taxi-boat to club pontoons also possible.", activities: "Long lunches at Club 55, loungers at Loulou, cocktails at Verde Beach. Turquoise water, tender rides, water-skiing.", transport: "car", mapX: 284, mapY: 417 },
      { name: "Ramatuelle & Gassin", kind: "Hilltop villages, vineyards", distance: "30 min by car", access: "D61 via Port Grimaud and La Foux. Park at village entrance, then walk up.", activities: "Medieval villages, shaded lanes, vineyards (Château Minuty, Domaines Ott, Tropez). Tastings by appointment.", transport: "car", mapX: 120, mapY: 440 },
    ],
  },
  amenities: {
    index: "VII",
