...
const fr: ChapterCopy = {
  ...
  art_of_living: {
    ...
    pois: [
      ...
      {
        name: "La Gaudina",
        kind: "Restaurant front de mer · Sainte-Maxime",
        distance: "5 min à pied",
        access: "Promenade Aymeric Simon-Lorière, sur le front de mer de Sainte-Maxime.",
        activities: "Cuisine méditerranéenne, vue mer, terrasse face au golfe. Déjeuner et dîner.",
        transport: "foot",
        mapX: 195,
        mapY: 178,
      },
      {
        name: "Marché couvert",
        kind: "Produits de Provence · jeudi & samedi",
        distance: "5 min à pied",
        access: "Par la rue Fernand Bessy, derrière l’église. Marché provençal en plein cœur de Sainte-Maxime.",
      ...
      },
      {
        ...
        kind: "Sable blanc, eau turquoise",
        distance: "8 min en voiture",
        access: "Suivez la D559 vers l’est sur 3 km. Parking sur la plage. Navette gratuite en été depuis le centre.",
      ...
      {
        name: "Le Sémaphore",
        kind: "Point de vue panoramique",
        distance: "30 min à pied",
        access: "Sentier du littoral, montée raide derrière la Nartelle. Prévoir des chaussures fermées et de l’eau.",
      ...
      },
      {
        ...
        access: "Navettes Bateaux Verts depuis la jetée de Sainte-Maxime (200 m à pied de L’Arbois) — horaires saisonniers.",
      ...
      {
        name: "Le WYC · Saint-Tropez",
        kind: "Wine & Yacht Club · port",
        distance: "15 min en bateau",
        access: "Bateaux Verts jusqu’au port de Saint-Tropez, puis 2 min à pied le long du quai Suffren.",
        activities: "Cuisine de saison, cave de référence, terrasse vue voiliers. Déjeuner long, dîner sous les étoiles.",
        transport: "boat",
        mapX: 222,
        mapY: 365,
      },
      {
        name: "La Voile · Cheval Blanc",
        kind: "Restaurant gastronomique · 1 étoile Michelin",
        distance: "15 min en bateau",
        access: "Bateaux Verts jusqu’au port de Saint-Tropez, puis 5 min à pied vers le Cheval Blanc.",
        activities: "Cuisine méditerranéenne signée Arnaud Donckele, jardin face à la mer, service d’exception. Réservation indispensable.",
        transport: "boat",
        mapX: 232,
        mapY: 372,
      },
      {
        ...
        access: "Descendez des Bateaux Verts au port, remontez la rue Gambetta sur 300 m. Marché mardi & samedi matin.",
      ...
      {
        name: "Le Prao",
        kind: "Restaurant pieds dans l’eau · Pampelonne",
        distance: "35 min en voiture",
        access: "Route des plages via Ramatuelle. Parking voiturier. Accessible aussi en taxi-boat privé jusqu’au ponton.",
        activities: "Plage privée, déjeuners longs, cuisine méditerranéenne raffinée, transats face à la mer.",
        transport: "car",
        mapX: 360,
        mapY: 425,
      },
      {
        ...
        access: "Route des plages via Ramatuelle. Ou taxi-boat privé jusqu’au ponton du club.",
      ...
      },
      {
        ...
        access: "Voiture par la D61 via Port Grimaud et La Foux. Stationnement en bas des villages.",
...
const en: ChapterCopy = {
  ...
  art_of_living: {
    ...
    pois: [
      { name: "La Croisette", kind: "Seafront promenade, port, yachts", distance: "2 min walk", access: "Step out of L’Arbois, turn left along the shaded seafront.", activities: "Promenade under umbrella pines, marina, café terraces, artisanal ice cream, sunset cocktail bars.", transport: "foot", mapX: 175, mapY: 175 },
      { name: "La Gaudina", kind: "Seafront restaurant · Sainte-Maxime", distance: "5 min walk", access: "Promenade Aymeric Simon-Lorière, on the Sainte-Maxime seafront.", activities: "Mediterranean cuisine, sea view, terrace facing the gulf. Lunch and dinner.", transport: "foot", mapX: 195, mapY: 178 },
      { name: "Covered market", kind: "Provence produce · Thu & Sat", distance: "5 min walk", access: "Via Rue Fernand Bessy, behind the church. Provençal market in the heart of Sainte-Maxime.", activities: "Farm cheeses, morning-catch fish, seasonal fruit, flowers, local olive oil, tapenades, rosé.", transport: "foot", mapX: 155, mapY: 110 },
      { name: "Nartelle beach", kind: "White sand, turquoise water", distance: "8 min by car", access: "D559 east for 3 km. Beach parking. Free shuttle in summer from the centre.", activities: "Fine sand, calm water (ideal for children), beach clubs (Mahi Plage, La Gaillarde, Havana), paddle, loungers, lunch on the sand.", transport: "car", mapX: 340, mapY: 165 },
      { name: "Le Sémaphore", kind: "Panoramic viewpoint", distance: "30 min walk", access: "Coastal path, steep climb above Nartelle. Wear closed shoes and bring water.", activities: "Full panorama of the gulf of Saint-Tropez, the finest sunsets, picnic area.", transport: "foot", mapX: 340, mapY: 90 },
      { name: "Sénéquier", kind: "Iconic café on the port · Saint-Tropez", distance: "15 min by boat", access: "Bateaux Verts shuttles from the Sainte-Maxime jetty (200 m walk from L’Arbois) — seasonal schedule.", activities: "Institution since 1887. Vivid red terrace on the port, early breakfast, sunset apéritif, the finest yacht-watching seat.", transport: "boat", mapX: 210, mapY: 360 },
      { name: "Le WYC · Saint-Tropez", kind: "Wine & Yacht Club · harbour", distance: "15 min by boat", access: "Bateaux Verts to the Saint-Tropez port, then 2 min walk along Quai Suffren.", activities: "Seasonal cuisine, reference wine cellar, terrace facing the sailing yachts. Long lunches, dinners under the stars.", transport: "boat", mapX: 222, mapY: 365 },
      { name: "La Voile · Cheval Blanc", kind: "Gastronomic restaurant · 1 Michelin star", distance: "15 min by boat", access: "Bateaux Verts to the Saint-Tropez port, then 5 min walk to Cheval Blanc.", activities: "Mediterranean cuisine by Arnaud Donckele, garden facing the sea, exceptional service. Booking essential.", transport: "boat", mapX: 232, mapY: 372 },
      { name: "Place des Lices", kind: "Pétanque, plane trees, market", distance: "15 min boat + 5 min walk", access: "Off the Bateaux Verts at the port, 300 m up Rue Gambetta. Market Tuesday & Saturday morning.", activities: "Pétanque under centennial plane trees, Provence market, shaded terraces, Le Café (historic brasserie), designer shops.", transport: "boat", mapX: 195, mapY: 385 },
      { name: "Le Prao", kind: "Beachfront restaurant · Pampelonne", distance: "35 min by car", access: "Route des plages via Ramatuelle. Valet parking. Also reachable by private taxi-boat to the pontoon.", activities: "Private beach, long lunches, refined Mediterranean cuisine, loungers facing the sea.", transport: "car", mapX: 360, mapY: 425 },
      { name: "Pampelonne beach", kind: "Club 55, Loulou, La Réserve, Nikki Beach", distance: "40 min by car", access: "Route des plages via Ramatuelle. Or private taxi-boat to a club pontoon.", activities: "Long lunches at Club 55, loungers at Loulou, cocktails at Nikki Beach. Turquoise water, tender rides, water-skiing.", transport: "car", mapX: 350, mapY: 440 },
      { name: "Ramatuelle & Gassin", kind: "Hilltop villages, vineyards", distance: "30 min by car", access: "D61 via Port Grimaud and La Foux. Parking at the village entrance.", activities: "Medieval villages, shaded lanes, vineyards (Château Minuty, Domaines Ott), restaurants with view. Tastings by appointment.", transport: "car", mapX: 295, mapY: 455 },
    ],
  },
  amenities: {
    index: "VII",
